/* Copyright (C) 2020 MadamMask.

Licensed under the  GPL-3.0 License;
you may not use this file except in compliance with the License.
 
Madammask - Dulensathsara
*/
...
${chalk.blue.italic(' Connecting to WhatsApp... 👨‍💻 Please Wait...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.blueBright.italic('👨‍💻 MADAM MASK 👨‍💻 Installing Plugins...')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'en' || config.LANG == 'en') {

                if (conn.user.jid === '@s.whatsapp.net') {

                    await conn.sendMessage(conn.user.jid, '```👨‍💻 Blacklist අනාවරණය විය!``` \n```පරිශීලක:``` \n```හේතුව:``` ', MessageType.text)
...
👨‍💻 MADAM MASK 👨‍💻 WhatsApp Bot public ආකාරයට ක්‍රියා කරයි.🌹*\n\n_මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකය වේ._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය 🌹_\n\n*ඔබේ command list එක ලබාගැනීමට .menu command බාවිතා කල හැකිය.*\n\n*ඔබේ bot public ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:private_ *විධානය භාවිතා කරන්න.*\n\n*Panda භාවිතා කිරීම ගැන ස්තූතියි 💀*', MessageType.text);
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*👨‍💻 MADAM MASK 👨‍💻 WhatsApp Bot public ආකාරයට ක්‍රියා කරයි.🌹 *\n_මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකය වේ._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n*ඔබේ command list එක ලබාගැනීමට .menu command බාවිතා කල හැකිය.*\n\n*ඔබේ bot public ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:private_ *විධානය භාවිතා කරන්න.*\n\n*BlackPanda භාවිතා කිරීම ගැන ස්තූතියි 💀*', MessageType.text);
                }
            ...
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                await conn.sendMessage(conn.user.jid, '*👨‍💻 MADAM MASK 👨‍💻 private ආකාරයට ක්‍රියා කරයි...*\n\n_මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකය වේ._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය 🌹_\n\n*ඔබේ command list එක ලබාගැනීමට .menu command බාවිතා කල හැකිය.*\n\n*ඔබේ bot private ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *විධානය භාවිතා කරන්න.*\n\n*🌹 MADAM MASK 🌹 භාවිතා කිරීම ගැන ස්තූතියි 👨‍💻*', MessageType.text);
                }
            }
            else {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*👨‍💻 MADAM MASK 👨‍💻 WhatsApp Bot private ආකාරයට ක්‍රියා කරයි. 🌹*\n\n_මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකය වේ._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය 🌹_\n\n*ඔබේ command list එක ලබාගැනීමට .BLACK command බාවිතා කල හැකිය.*\n\n*ඔබේ bot private ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *විධානය භාවිතා කරන්න.*\n\n*BlackPanda භාවිතා කිරීම ගැන ස්තූතියි 💀🔱*', MessageType.text);
                }
            }
        }
        else {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- දෝෂ වාර්තාව [👨‍💻 MADAM MASK 👨‍💻] --*' + 
                                    ...
                                    '\n_https://chat.whatsapp.com/J5agXAJhiY0Et7gXtdeeEl ඔබට එය මෙම සමූහයට යොමු කළ හැකිය._\n\n' +
                                    '*සිදු වූ දෝෂය:* ```' + error + '```\n\n'
                                    , MessageType.text, {detectLinks: false});
                            } else {
                                await conn.sendMessage(conn.user.jid, '*-- බොට් වාර්තාව [👨‍💻 MADAM MASK 👨‍💻] --*' + 
                                    ...
                                    '\n_ඔබේ bot සඳහා යම් උදව්වක් අවශ්‍ය නම්, https://chat.whatsapp.com/J5agXAJhiY0Et7gXtdeeEl_\n\n' +
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
                            }
                        }
